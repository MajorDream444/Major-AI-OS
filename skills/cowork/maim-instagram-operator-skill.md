...
Escalate to Major directly if:
- Account gets restricted or flagged by Meta
- Intake form is broken or returning errors
- A post gets significant negative response
- Follower count drops unexpectedly
